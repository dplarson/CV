...
H.~T.~C., \textbf{D.~P. Larson}, and C.~F.~M. Coimbra (2019) ``A comprehensive dataset for the accelerated development and benchmarking of solar forecasting methods'', JRSE \textit{(submitted)}.
