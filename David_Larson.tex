...
Developed novel solar power forecasting methods for large-scale photovoltaic power plants.
...
(Word, Excel, Powerpoint), LaTeX, Pro/ENGINEER, Solidworks, command-line tools
(vim, ssh, etc.)
