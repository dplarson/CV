...
\section{Undergraduate Research Mentorship}
...
\textbf{Software}
\begin{innerlist}
	\item Languages: Python, Matlab, Mathematica, UNIX Shell
    \item Version Control: Git
    \item TeX: LaTeX, Bibtex
    \item CAD: Pro/ENGINEER, Autodesk Inventor
\end{innerlist}
