...
\href{http://www.asme.org/}{American Society of Mechanical Engineers} \\
Student Member \hfill 2009--present

\blankline

\href{http://www.eswusa.org/}{Engineers for a Sustainable World} \\
...
Programming:
\begin{innerlist}
	\item \Matlab, Python, Mathematica, PHP, MySQL, Unix shell scripting
\end{innerlist}
...
\begin{innerlist}
    ...
    \item \href{http://gitlab.org}{Gitlab}
\end{innerlist}
