...
\textit{University of California, Merced}
\begin{innerlist}
    \item Investigated phase separation in lipid tubules
\end{innerlist}
...
\textit{University of California, San Diego}
\begin{innerlist}
    \item ENG 1: Fall 2013
    \item ENG 2: Winter 2014
    \item ENG 3: Spring 2014
\end{innerlist}

\section{Undergraduate Mentoring}

\textbf{MAE 126B (Senior Environmental Engineering Design)} \hfill 2014 \\
\textit{University of California, San Diego}
\begin{innerlist}
...
\textbf{MAE 199 (Independent Study)} \hfill 2013 \\
\textit{University of California, San Diego}
\begin{innerlist}
    \item Marina Fernandez (Winter 2013): Contrail effects on ground-based solar irradiance measurements
    \item Jeremy Orosco (Spring 2013): Method for forecasting chaotic time series
\end{innerlist}
