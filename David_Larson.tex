...
Evolutionary Methods, Genetic Algorithms, Shape Optimization, Bio-inspiration, Fluid Mechanics of biological locomotion, Fractional and Variable Order Methods
...
\begin{innerlist}
    ...
    \item Manage group information infrastructure
\end{innerlist}
...
\begin{innerlist}
    \item Lab: \href{http://coimbra.ucsd.edu/}{Coimbra Group} 
    \item Location: University of California, San Diego
    \item Investigating the application of Fractional and Variable Order Methods to Nonlinear Chaos Dynamics
\end{innerlist}
